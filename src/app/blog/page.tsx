...
const blogJsonLd = {
  ...
  "@type": "Blog",
  name: "KIHause Blog",
  description: "Praxiswissen rund um lokale KI und Datenschutz in Berlin.",
  url: "https://kihause.de/blog",
  publisher: {
    "@type": "Organization",
    name: "KIHause",
  },
    ...
    <>
      ...
      <main className="pt-32 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Top CTA banner */}
          <a
            href="https://wa.me/491776525804?text=Hallo%20KIHause!%20Ich%20habe%20Ihren%20Blog%20gelesen%20und%20möchte%20mehr%20erfahren."
            target="_blank"
          ...
          >
            ...
            <span>Jetzt via WhatsApp schreiben und in 4h Antwort erhalten</span>
            <svg className="w-5 h-5 inline-block ml-2 -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
