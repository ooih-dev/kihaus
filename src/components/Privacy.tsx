...
export default function Privacy() {
  ...
  return (
    <section id="datenschutz" className="py-24 bg-white relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-96 h-96 bg-emerald-100/30 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-20 w-72 h-72 bg-emerald-50/50 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-2xl overflow-hidden border border-slate-200">
            <div className="grid grid-cols-3 bg-slate-50">
              ...
              <div className="p-4 text-sm font-semibold text-red-500 text-center">
                Cloud-KI (ChatGPT & Co.)
              </div>
              <div className="p-4 text-sm font-semibold text-emerald-600 text-center">
                KIHause (Lokal)
              </div>
            </div>
            ...
            {t.comparison.rows.map((c, i) => (
              ...
              >
                ...
                <div className="p-4 text-sm text-slate-900 text-center flex items-center justify-center gap-2">
        ...
        <blockquote className="mt-16 max-w-3xl mx-auto text-center">
          ...
          <footer className="mt-4 text-emerald-600 font-medium">
