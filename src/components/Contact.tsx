            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hallo@kihause.de" className="text-primary-600 hover:underline">
                    hallo@kihause.de
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900">{t.contact.location}</div>
                  <p className="text-slate-500">{t.contact.locationDesc}</p>
                  <p className="text-sm text-slate-400">{t.contact.locationSub}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">{t.contact.whatsappSub}</p>
                </div>
              </div>
            </div>
          </div>
